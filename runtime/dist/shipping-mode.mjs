...
function validate18(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
  ...
  if (errors = _errs2, vErrors !== null && (_errs2 ? vErrors.length = _errs2 : vErrors = null), _valid0) {
    let _errs5 = errors;
    if (data && typeof data == "object" && !Array.isArray(data) && data.provider !== void 0 && data.provider !== "none") {
      let err1 = { instancePath: instancePath + "/provider", schemaPath: "#/allOf/0/then/properties/provider/const", keyword: "const", params: { allowedValue: "none" }, message: "must be equal to constant" };
  ...
  if (!valid1) {
    let err2 = { instancePath, schemaPath: "#/allOf/0/if", keyword: "if", params: { failingKeyword: "then" }, message: 'must match "then" schema' };
    vErrors === null ? vErrors = [err2] : vErrors.push(err2), errors++;
  }
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.enabled === void 0) {
      let err3 = { instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: "enabled" }, message: "must have required property 'enabled'" };
      vErrors === null ? vErrors = [err3] : vErrors.push(err3), errors++;
    }
    if (data.provider === void 0) {
      let err4 = { instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: "provider" }, message: "must have required property 'provider'" };
      vErrors === null ? vErrors = [err4] : vErrors.push(err4), errors++;
    }
    for (let key0 in data)
      if (!(key0 === "enabled" || key0 === "provider" || key0 === "branches" || key0 === "work" || key0 === "worktrees" || key0 === "commits" || key0 === "pull_requests" || key0 === "automation")) {
        let err5 = { instancePath, schemaPath: "#/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key0 }, message: "must NOT have additional properties" };
        vErrors === null ? vErrors = [err5] : vErrors.push(err5), errors++;
      }
    if (data.enabled !== void 0 && typeof data.enabled != "boolean") {
      let err6 = { instancePath: instancePath + "/enabled", schemaPath: "#/properties/enabled/type", keyword: "type", params: { type: "boolean" }, message: "must be boolean" };
      vErrors === null ? vErrors = [err6] : vErrors.push(err6), errors++;
    }
    if (data.provider !== void 0) {
      let data3 = data.provider;
      if (!(data3 === "github" || data3 === "gitlab" || data3 === "azure-devops" || data3 === "none" || data3 === "custom")) {
        let err7 = { instancePath: instancePath + "/provider", schemaPath: "#/properties/provider/enum", keyword: "enum", params: { allowedValues: schema13.properties.provider.enum }, message: "must be equal to one of the allowed values" };
        vErrors === null ? vErrors = [err7] : vErrors.push(err7), errors++;
      }
    }
    if (data.branches !== void 0) {
      let data4 = data.branches;
      if (data4 && typeof data4 == "object" && !Array.isArray(data4)) {
        for (let key1 in data4)
          if (!(key1 === "work_base" || key1 === "integration" || key1 === "production")) {
            let err8 = { instancePath: instancePath + "/branches", schemaPath: "#/$defs/gitBranches/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key1 }, message: "must NOT have additional properties" };
            vErrors === null ? vErrors = [err8] : vErrors.push(err8), errors++;
          }
        if (data4.work_base !== void 0) {
          let data5 = data4.work_base;
          if (typeof data5 != "string" && data5 !== null) {
            let err9 = { instancePath: instancePath + "/branches/work_base", schemaPath: "#/$defs/gitBranches/properties/work_base/type", keyword: "type", params: { type: schema14.properties.work_base.type }, message: "must be string,null" };
            vErrors === null ? vErrors = [err9] : vErrors.push(err9), errors++;
          }
          if (typeof data5 == "string" && func2(data5) < 1) {
            let err10 = { instancePath: instancePath + "/branches/work_base", schemaPath: "#/$defs/gitBranches/properties/work_base/minLength", keyword: "minLength", params: { limit: 1 }, message: "must NOT have fewer than 1 characters" };
            vErrors === null ? vErrors = [err10] : vErrors.push(err10), errors++;
          }
        }
        if (data4.integration !== void 0) {
          let data6 = data4.integration;
          if (typeof data6 != "string" && data6 !== null) {
            let err11 = { instancePath: instancePath + "/branches/integration", schemaPath: "#/$defs/gitBranches/properties/integration/type", keyword: "type", params: { type: schema14.properties.integration.type }, message: "must be string,null" };
            vErrors === null ? vErrors = [err11] : vErrors.push(err11), errors++;
          }
          if (typeof data6 == "string" && func2(data6) < 1) {
            let err12 = { instancePath: instancePath + "/branches/integration", schemaPath: "#/$defs/gitBranches/properties/integration/minLength", keyword: "minLength", params: { limit: 1 }, message: "must NOT have fewer than 1 characters" };
            vErrors === null ? vErrors = [err12] : vErrors.push(err12), errors++;
          }
        }
        if (data4.production !== void 0) {
          let data7 = data4.production;
          if (typeof data7 != "string" && data7 !== null) {
            let err13 = { instancePath: instancePath + "/branches/production", schemaPath: "#/$defs/gitBranches/properties/production/type", keyword: "type", params: { type: schema14.properties.production.type }, message: "must be string,null" };
            vErrors === null ? vErrors = [err13] : vErrors.push(err13), errors++;
          }
          if (typeof data7 == "string" && func2(data7) < 1) {
            let err14 = { instancePath: instancePath + "/branches/production", schemaPath: "#/$defs/gitBranches/properties/production/minLength", keyword: "minLength", params: { limit: 1 }, message: "must NOT have fewer than 1 characters" };
            vErrors === null ? vErrors = [err14] : vErrors.push(err14), errors++;
          }
        }
      } else {
        let err15 = { instancePath: instancePath + "/branches", schemaPath: "#/$defs/gitBranches/type", keyword: "type", params: { type: "object" }, message: "must be object" };
    ...
    if (data.work !== void 0) {
      ...
      if (data8 && typeof data8 == "object" && !Array.isArray(data8)) {
        if (data8.branch_unit === void 0) {
          let err16 = { instancePath: instancePath + "/work", schemaPath: "#/$defs/gitWorkPolicy/required", keyword: "required", params: { missingProperty: "branch_unit" }, message: "must have required property 'branch_unit'" };
          vErrors === null ? vErrors = [err16] : vErrors.push(err16), errors++;
        }
        if (data8.branch_pattern === void 0) {
          let err17 = { instancePath: instancePath + "/work", schemaPath: "#/$defs/gitWorkPolicy/required", keyword: "required", params: { missingProperty: "branch_pattern" }, message: "must have required property 'branch_pattern'" };
          vErrors === null ? vErrors = [err17] : vErrors.push(err17), errors++;
        }
        if (data8.reuse === void 0) {
          let err18 = { instancePath: instancePath + "/work", schemaPath: "#/$defs/gitWorkPolicy/required", keyword: "required", params: { missingProperty: "reuse" }, message: "must have required property 'reuse'" };
          vErrors === null ? vErrors = [err18] : vErrors.push(err18), errors++;
        }
        for (let key2 in data8)
          if (!(key2 === "branch_unit" || key2 === "branch_pattern" || key2 === "reuse")) {
            let err19 = { instancePath: instancePath + "/work", schemaPath: "#/$defs/gitWorkPolicy/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key2 }, message: "must NOT have additional properties" };
            vErrors === null ? vErrors = [err19] : vErrors.push(err19), errors++;
          }
        if (data8.branch_unit !== void 0) {
          let data9 = data8.branch_unit;
          if (!(data9 === "task" || data9 === "work_package" || data9 === "release_item" || data9 === "release" || data9 === "manual")) {
            let err20 = { instancePath: instancePath + "/work/branch_unit", schemaPath: "#/$defs/gitWorkPolicy/properties/branch_unit/enum", keyword: "enum", params: { allowedValues: schema15.properties.branch_unit.enum }, message: "must be equal to one of the allowed values" };
            vErrors === null ? vErrors = [err20] : vErrors.push(err20), errors++;
          }
        }
        if (data8.branch_pattern !== void 0) {
          let data10 = data8.branch_pattern;
          if (typeof data10 == "string") {
            if (func2(data10) < 1) {
              let err21 = { instancePath: instancePath + "/work/branch_pattern", schemaPath: "#/$defs/gitWorkPolicy/properties/branch_pattern/minLength", keyword: "minLength", params: { limit: 1 }, message: "must NOT have fewer than 1 characters" };
              vErrors === null ? vErrors = [err21] : vErrors.push(err21), errors++;
            }
          } else {
            let err22 = { instancePath: instancePath + "/work/branch_pattern", schemaPath: "#/$defs/gitWorkPolicy/properties/branch_pattern/type", keyword: "type", params: { type: "string" }, message: "must be string" };
            vErrors === null ? vErrors = [err22] : vErrors.push(err22), errors++;
          }
        }
        if (data8.reuse !== void 0) {
          let data11 = data8.reuse;
          if (!(data11 === "within_task" || data11 === "within_work_package" || data11 === "never" || data11 === "manual")) {
            let err23 = { instancePath: instancePath + "/work/reuse", schemaPath: "#/$defs/gitWorkPolicy/properties/reuse/enum", keyword: "enum", params: { allowedValues: schema15.properties.reuse.enum }, message: "must be equal to one of the allowed values" };
            vErrors === null ? vErrors = [err23] : vErrors.push(err23), errors++;
          }
        }
      } else {
        let err24 = { instancePath: instancePath + "/work", schemaPath: "#/$defs/gitWorkPolicy/type", keyword: "type", params: { type: "object" }, message: "must be object" };
        vErrors === null ? vErrors = [err24] : vErrors.push(err24), errors++;
      }
    }
    if (data.worktrees !== void 0) {
      let data12 = data.worktrees;
      if (data12 && typeof data12 == "object" && !Array.isArray(data12)) {
        if (data12.mode === void 0) {
          let err25 = { instancePath: instancePath + "/worktrees", schemaPath: "#/$defs/gitWorktreePolicy/required", keyword: "required", params: { missingProperty: "mode" }, message: "must have required property 'mode'" };
          vErrors === null ? vErrors = [err25] : vErrors.push(err25), errors++;
        }
        if (data12.unit === void 0) {
          let err26 = { instancePath: instancePath + "/worktrees", schemaPath: "#/$defs/gitWorktreePolicy/required", keyword: "required", params: { missingProperty: "unit" }, message: "must have required property 'unit'" };
          vErrors === null ? vErrors = [err26] : vErrors.push(err26), errors++;
        }
        if (data12.cleanup === void 0) {
          let err27 = { instancePath: instancePath + "/worktrees", schemaPath: "#/$defs/gitWorktreePolicy/required", keyword: "required", params: { missingProperty: "cleanup" }, message: "must have required property 'cleanup'" };
          vErrors === null ? vErrors = [err27] : vErrors.push(err27), errors++;
        }
        for (let key3 in data12)
          if (!(key3 === "mode" || key3 === "unit" || key3 === "cleanup")) {
            let err28 = { instancePath: instancePath + "/worktrees", schemaPath: "#/$defs/gitWorktreePolicy/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key3 }, message: "must NOT have additional properties" };
            vErrors === null ? vErrors = [err28] : vErrors.push(err28), errors++;
          }
        if (data12.mode !== void 0) {
          let data13 = data12.mode;
          if (!(data13 === "disabled" || data13 === "optional" || data13 === "required")) {
            let err29 = { instancePath: instancePath + "/worktrees/mode", schemaPath: "#/$defs/gitWorktreePolicy/properties/mode/enum", keyword: "enum", params: { allowedValues: schema16.properties.mode.enum }, message: "must be equal to one of the allowed values" };
            vErrors === null ? vErrors = [err29] : vErrors.push(err29), errors++;
          }
        }
        if (data12.unit !== void 0) {
          let data14 = data12.unit;
          if (!(data14 === "task" || data14 === "work_package" || data14 === "release_item" || data14 === "release" || data14 === "manual")) {
            let err30 = { instancePath: instancePath + "/worktrees/unit", schemaPath: "#/$defs/gitWorktreePolicy/properties/unit/enum", keyword: "enum", params: { allowedValues: schema16.properties.unit.enum }, message: "must be equal to one of the allowed values" };
            vErrors === null ? vErrors = [err30] : vErrors.push(err30), errors++;
          }
        }
        if (data12.cleanup !== void 0) {
          let data15 = data12.cleanup;
          if (!(data15 === "after_integration" || data15 === "manual" || data15 === "never")) {
            let err31 = { instancePath: instancePath + "/worktrees/cleanup", schemaPath: "#/$defs/gitWorktreePolicy/properties/cleanup/enum", keyword: "enum", params: { allowedValues: schema16.properties.cleanup.enum }, message: "must be equal to one of the allowed values" };
            vErrors === null ? vErrors = [err31] : vErrors.push(err31), errors++;
          }
        }
      } else {
        let err32 = { instancePath: instancePath + "/worktrees", schemaPath: "#/$defs/gitWorktreePolicy/type", keyword: "type", params: { type: "object" }, message: "must be object" };
        vErrors === null ? vErrors = [err32] : vErrors.push(err32), errors++;
      }
    }
    if (data.commits !== void 0) {
      let data16 = data.commits;
      if (data16 && typeof data16 == "object" && !Array.isArray(data16)) {
        if (data16.granularity === void 0) {
          let err33 = { instancePath: instancePath + "/commits", schemaPath: "#/$defs/gitCommitPolicy/required", keyword: "required", params: { missingProperty: "granularity" }, message: "must have required property 'granularity'" };
          vErrors === null ? vErrors = [err33] : vErrors.push(err33), errors++;
        }
        if (data16.message_policy === void 0) {
          let err34 = { instancePath: instancePath + "/commits", schemaPath: "#/$defs/gitCommitPolicy/required", keyword: "required", params: { missingProperty: "message_policy" }, message: "must have required property 'message_policy'" };
          vErrors === null ? vErrors = [err34] : vErrors.push(err34), errors++;
        }
        for (let key4 in data16)
          if (!(key4 === "granularity" || key4 === "message_policy")) {
            let err35 = { instancePath: instancePath + "/commits", schemaPath: "#/$defs/gitCommitPolicy/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key4 }, message: "must NOT have additional properties" };
            vErrors === null ? vErrors = [err35] : vErrors.push(err35), errors++;
          }
        if (data16.granularity !== void 0) {
          let data17 = data16.granularity;
          if (!(data17 === "task" || data17 === "work_package" || data17 === "release_item" || data17 === "release" || data17 === "manual")) {
            let err36 = { instancePath: instancePath + "/commits/granularity", schemaPath: "#/$defs/gitCommitPolicy/properties/granularity/enum", keyword: "enum", params: { allowedValues: schema17.properties.granularity.enum }, message: "must be equal to one of the allowed values" };
            vErrors === null ? vErrors = [err36] : vErrors.push(err36), errors++;
          }
        }
        if (data16.message_policy !== void 0) {
          let data18 = data16.message_policy;
          if (!(data18 === "host_defined" || data18 === "conventional" || data18 === "custom")) {
            let err37 = { instancePath: instancePath + "/commits/message_policy", schemaPath: "#/$defs/gitCommitPolicy/properties/message_policy/enum", keyword: "enum", params: { allowedValues: schema17.properties.message_policy.enum }, message: "must be equal to one of the allowed values" };
            vErrors === null ? vErrors = [err37] : vErrors.push(err37), errors++;
          }
        }
      } else {
        let err38 = { instancePath: instancePath + "/commits", schemaPath: "#/$defs/gitCommitPolicy/type", keyword: "type", params: { type: "object" }, message: "must be object" };
        vErrors === null ? vErrors = [err38] : vErrors.push(err38), errors++;
      }
    }
    if (data.pull_requests !== void 0) {
      let data19 = data.pull_requests;
      if (data19 && typeof data19 == "object" && !Array.isArray(data19)) {
        if (data19.enabled === void 0) {
          let err39 = { instancePath: instancePath + "/pull_requests", schemaPath: "#/$defs/gitPullRequestPolicy/required", keyword: "required", params: { missingProperty: "enabled" }, message: "must have required property 'enabled'" };
          vErrors === null ? vErrors = [err39] : vErrors.push(err39), errors++;
        }
        if (data19.work_target === void 0) {
          let err40 = { instancePath: instancePath + "/pull_requests", schemaPath: "#/$defs/gitPullRequestPolicy/required", keyword: "required", params: { missingProperty: "work_target" }, message: "must have required property 'work_target'" };
          vErrors === null ? vErrors = [err40] : vErrors.push(err40), errors++;
        }
        if (data19.draft_by_default === void 0) {
          let err41 = { instancePath: instancePath + "/pull_requests", schemaPath: "#/$defs/gitPullRequestPolicy/required", keyword: "required", params: { missingProperty: "draft_by_default" }, message: "must have required property 'draft_by_default'" };
          vErrors === null ? vErrors = [err41] : vErrors.push(err41), errors++;
        }
        if (data19.merge_strategy === void 0) {
          let err42 = { instancePath: instancePath + "/pull_requests", schemaPath: "#/$defs/gitPullRequestPolicy/required", keyword: "required", params: { missingProperty: "merge_strategy" }, message: "must have required property 'merge_strategy'" };
          vErrors === null ? vErrors = [err42] : vErrors.push(err42), errors++;
        }
        if (data19.promotion === void 0) {
          let err43 = { instancePath: instancePath + "/pull_requests", schemaPath: "#/$defs/gitPullRequestPolicy/required", keyword: "required", params: { missingProperty: "promotion" }, message: "must have required property 'promotion'" };
          vErrors === null ? vErrors = [err43] : vErrors.push(err43), errors++;
        }
        for (let key5 in data19)
          if (!(key5 === "enabled" || key5 === "work_target" || key5 === "draft_by_default" || key5 === "merge_strategy" || key5 === "promotion")) {
            let err44 = { instancePath: instancePath + "/pull_requests", schemaPath: "#/$defs/gitPullRequestPolicy/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key5 }, message: "must NOT have additional properties" };
            vErrors === null ? vErrors = [err44] : vErrors.push(err44), errors++;
          }
        if (data19.enabled !== void 0 && typeof data19.enabled != "boolean") {
          let err45 = { instancePath: instancePath + "/pull_requests/enabled", schemaPath: "#/$defs/gitPullRequestPolicy/properties/enabled/type", keyword: "type", params: { type: "boolean" }, message: "must be boolean" };
          vErrors === null ? vErrors = [err45] : vErrors.push(err45), errors++;
        }
        if (data19.work_target !== void 0) {
          let data21 = data19.work_target;
          if (typeof data21 != "string" && data21 !== null) {
            let err46 = { instancePath: instancePath + "/pull_requests/work_target", schemaPath: "#/$defs/gitPullRequestPolicy/properties/work_target/type", keyword: "type", params: { type: schema18.properties.work_target.type }, message: "must be string,null" };
            vErrors === null ? vErrors = [err46] : vErrors.push(err46), errors++;
          }
          if (typeof data21 == "string" && func2(data21) < 1) {
            let err47 = { instancePath: instancePath + "/pull_requests/work_target", schemaPath: "#/$defs/gitPullRequestPolicy/properties/work_target/minLength", keyword: "minLength", params: { limit: 1 }, message: "must NOT have fewer than 1 characters" };
            vErrors === null ? vErrors = [err47] : vErrors.push(err47), errors++;
          }
        }
        if (data19.draft_by_default !== void 0 && typeof data19.draft_by_default != "boolean") {
          let err48 = { instancePath: instancePath + "/pull_requests/draft_by_default", schemaPath: "#/$defs/gitPullRequestPolicy/properties/draft_by_default/type", keyword: "type", params: { type: "boolean" }, message: "must be boolean" };
          vErrors === null ? vErrors = [err48] : vErrors.push(err48), errors++;
        }
        if (data19.merge_strategy !== void 0) {
          let data23 = data19.merge_strategy;
          if (!(data23 === "merge" || data23 === "squash" || data23 === "rebase" || data23 === "provider_default" || data23 === "none")) {
            let err49 = { instancePath: instancePath + "/pull_requests/merge_strategy", schemaPath: "#/$defs/gitPullRequestPolicy/properties/merge_strategy/enum", keyword: "enum", params: { allowedValues: schema18.properties.merge_strategy.enum }, message: "must be equal to one of the allowed values" };
            vErrors === null ? vErrors = [err49] : vErrors.push(err49), errors++;
          }
        }
        if (data19.promotion !== void 0) {
          let data24 = data19.promotion;
          if (data24 && typeof data24 == "object" && !Array.isArray(data24)) {
            if (data24.source === void 0) {
              let err50 = { instancePath: instancePath + "/pull_requests/promotion", schemaPath: "#/$defs/gitPullRequestPolicy/properties/promotion/required", keyword: "required", params: { missingProperty: "source" }, message: "must have required property 'source'" };
              vErrors === null ? vErrors = [err50] : vErrors.push(err50), errors++;
            }
            if (data24.target === void 0) {
              let err51 = { instancePath: instancePath + "/pull_requests/promotion", schemaPath: "#/$defs/gitPullRequestPolicy/properties/promotion/required", keyword: "required", params: { missingProperty: "target" }, message: "must have required property 'target'" };
              vErrors === null ? vErrors = [err51] : vErrors.push(err51), errors++;
            }
            for (let key6 in data24)
              if (!(key6 === "source" || key6 === "target")) {
                let err52 = { instancePath: instancePath + "/pull_requests/promotion", schemaPath: "#/$defs/gitPullRequestPolicy/properties/promotion/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key6 }, message: "must NOT have additional properties" };
                vErrors === null ? vErrors = [err52] : vErrors.push(err52), errors++;
              }
            if (data24.source !== void 0) {
              let data25 = data24.source;
              if (typeof data25 != "string" && data25 !== null) {
                let err53 = { instancePath: instancePath + "/pull_requests/promotion/source", schemaPath: "#/$defs/gitPullRequestPolicy/properties/promotion/properties/source/type", keyword: "type", params: { type: schema18.properties.promotion.properties.source.type }, message: "must be string,null" };
                vErrors === null ? vErrors = [err53] : vErrors.push(err53), errors++;
              }
              if (typeof data25 == "string" && func2(data25) < 1) {
                let err54 = { instancePath: instancePath + "/pull_requests/promotion/source", schemaPath: "#/$defs/gitPullRequestPolicy/properties/promotion/properties/source/minLength", keyword: "minLength", params: { limit: 1 }, message: "must NOT have fewer than 1 characters" };
                vErrors === null ? vErrors = [err54] : vErrors.push(err54), errors++;
              }
            }
            if (data24.target !== void 0) {
              let data26 = data24.target;
              if (typeof data26 != "string" && data26 !== null) {
                let err55 = { instancePath: instancePath + "/pull_requests/promotion/target", schemaPath: "#/$defs/gitPullRequestPolicy/properties/promotion/properties/target/type", keyword: "type", params: { type: schema18.properties.promotion.properties.target.type }, message: "must be string,null" };
                vErrors === null ? vErrors = [err55] : vErrors.push(err55), errors++;
              }
              if (typeof data26 == "string" && func2(data26) < 1) {
                let err56 = { instancePath: instancePath + "/pull_requests/promotion/target", schemaPath: "#/$defs/gitPullRequestPolicy/properties/promotion/properties/target/minLength", keyword: "minLength", params: { limit: 1 }, message: "must NOT have fewer than 1 characters" };
                vErrors === null ? vErrors = [err56] : vErrors.push(err56), errors++;
              }
            }
          } else {
            let err57 = { instancePath: instancePath + "/pull_requests/promotion", schemaPath: "#/$defs/gitPullRequestPolicy/properties/promotion/type", keyword: "type", params: { type: "object" }, message: "must be object" };
            vErrors === null ? vErrors = [err57] : vErrors.push(err57), errors++;
          }
        }
      } else {
        let err58 = { instancePath: instancePath + "/pull_requests", schemaPath: "#/$defs/gitPullRequestPolicy/type", keyword: "type", params: { type: "object" }, message: "must be object" };
        vErrors === null ? vErrors = [err58] : vErrors.push(err58), errors++;
      }
    }
    if (data.automation !== void 0) {
      let data27 = data.automation;
      if (data27 && typeof data27 == "object" && !Array.isArray(data27)) {
        if (data27.create_branch === void 0) {
          let err59 = { instancePath: instancePath + "/automation", schemaPath: "#/$defs/gitAutomationPolicy/required", keyword: "required", params: { missingProperty: "create_branch" }, message: "must have required property 'create_branch'" };
          vErrors === null ? vErrors = [err59] : vErrors.push(err59), errors++;
        }
        if (data27.create_worktree === void 0) {
          let err60 = { instancePath: instancePath + "/automation", schemaPath: "#/$defs/gitAutomationPolicy/required", keyword: "required", params: { missingProperty: "create_worktree" }, message: "must have required property 'create_worktree'" };
          vErrors === null ? vErrors = [err60] : vErrors.push(err60), errors++;
        }
        if (data27.commit === void 0) {
          let err61 = { instancePath: instancePath + "/automation", schemaPath: "#/$defs/gitAutomationPolicy/required", keyword: "required", params: { missingProperty: "commit" }, message: "must have required property 'commit'" };
          vErrors === null ? vErrors = [err61] : vErrors.push(err61), errors++;
        }
        if (data27.push === void 0) {
          let err62 = { instancePath: instancePath + "/automation", schemaPath: "#/$defs/gitAutomationPolicy/required", keyword: "required", params: { missingProperty: "push" }, message: "must have required property 'push'" };
          vErrors === null ? vErrors = [err62] : vErrors.push(err62), errors++;
        }
        if (data27.create_pr === void 0) {
          let err63 = { instancePath: instancePath + "/automation", schemaPath: "#/$defs/gitAutomationPolicy/required", keyword: "required", params: { missingProperty: "create_pr" }, message: "must have required property 'create_pr'" };
          vErrors === null ? vErrors = [err63] : vErrors.push(err63), errors++;
        }
        if (data27.merge_pr === void 0) {
          let err64 = { instancePath: instancePath + "/automation", schemaPath: "#/$defs/gitAutomationPolicy/required", keyword: "required", params: { missingProperty: "merge_pr" }, message: "must have required property 'merge_pr'" };
          vErrors === null ? vErrors = [err64] : vErrors.push(err64), errors++;
        }
        for (let key7 in data27)
          if (!(key7 === "create_branch" || key7 === "create_worktree" || key7 === "commit" || key7 === "push" || key7 === "create_pr" || key7 === "merge_pr")) {
            let err65 = { instancePath: instancePath + "/automation", schemaPath: "#/$defs/gitAutomationPolicy/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key7 }, message: "must NOT have additional properties" };
            vErrors === null ? vErrors = [err65] : vErrors.push(err65), errors++;
          }
        if (data27.create_branch !== void 0) {
          let data28 = data27.create_branch;
          if (!(data28 === "allowed" || data28 === "approval_required" || data28 === "forbidden")) {
            let err66 = { instancePath: instancePath + "/automation/create_branch", schemaPath: "#/$defs/gitAutomationPolicy/properties/create_branch/enum", keyword: "enum", params: { allowedValues: schema19.properties.create_branch.enum }, message: "must be equal to one of the allowed values" };
            vErrors === null ? vErrors = [err66] : vErrors.push(err66), errors++;
          }
        }
        if (data27.create_worktree !== void 0) {
          let data29 = data27.create_worktree;
          if (!(data29 === "allowed" || data29 === "approval_required" || data29 === "forbidden")) {
            let err67 = { instancePath: instancePath + "/automation/create_worktree", schemaPath: "#/$defs/gitAutomationPolicy/properties/create_worktree/enum", keyword: "enum", params: { allowedValues: schema19.properties.create_worktree.enum }, message: "must be equal to one of the allowed values" };
            vErrors === null ? vErrors = [err67] : vErrors.push(err67), errors++;
          }
        }
        if (data27.commit !== void 0) {
          let data30 = data27.commit;
          if (!(data30 === "allowed" || data30 === "approval_required" || data30 === "forbidden")) {
            let err68 = { instancePath: instancePath + "/automation/commit", schemaPath: "#/$defs/gitAutomationPolicy/properties/commit/enum", keyword: "enum", params: { allowedValues: schema19.properties.commit.enum }, message: "must be equal to one of the allowed values" };
            vErrors === null ? vErrors = [err68] : vErrors.push(err68), errors++;
          }
        }
        if (data27.push !== void 0) {
          let data31 = data27.push;
          if (!(data31 === "allowed" || data31 === "approval_required" || data31 === "forbidden")) {
            let err69 = { instancePath: instancePath + "/automation/push", schemaPath: "#/$defs/gitAutomationPolicy/properties/push/enum", keyword: "enum", params: { allowedValues: schema19.properties.push.enum }, message: "must be equal to one of the allowed values" };
            vErrors === null ? vErrors = [err69] : vErrors.push(err69), errors++;
          }
        }
        if (data27.create_pr !== void 0) {
          let data32 = data27.create_pr;
          if (!(data32 === "allowed" || data32 === "approval_required" || data32 === "forbidden")) {
            let err70 = { instancePath: instancePath + "/automation/create_pr", schemaPath: "#/$defs/gitAutomationPolicy/properties/create_pr/enum", keyword: "enum", params: { allowedValues: schema19.properties.create_pr.enum }, message: "must be equal to one of the allowed values" };
            vErrors === null ? vErrors = [err70] : vErrors.push(err70), errors++;
          }
        }
        if (data27.merge_pr !== void 0) {
          let data33 = data27.merge_pr;
          if (!(data33 === "allowed" || data33 === "approval_required" || data33 === "forbidden")) {
            let err71 = { instancePath: instancePath + "/automation/merge_pr", schemaPath: "#/$defs/gitAutomationPolicy/properties/merge_pr/enum", keyword: "enum", params: { allowedValues: schema19.properties.merge_pr.enum }, message: "must be equal to one of the allowed values" };
            vErrors === null ? vErrors = [err71] : vErrors.push(err71), errors++;
          }
        }
      } else {
        let err72 = { instancePath: instancePath + "/automation", schemaPath: "#/$defs/gitAutomationPolicy/type", keyword: "type", params: { type: "object" }, message: "must be object" };
...
function validate20(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    let missing0;
    if (data.provider === void 0 && (missing0 = "provider")) {
      let err0 = {};
      vErrors === null ? vErrors = [err0] : vErrors.push(err0), errors++;
    } else if (data.provider !== void 0 && data.provider !== "local_repository") {
      let err1 = {};
      vErrors === null ? vErrors = [err1] : vErrors.push(err1), errors++;
    }
  }
  ...
  if (errors = _errs2, vErrors !== null && (_errs2 ? vErrors.length = _errs2 : vErrors = null), _valid0) {
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
      if (data.roots === void 0) {
        let err2 = { instancePath, schemaPath: "#/allOf/0/then/required", keyword: "required", params: { missingProperty: "roots" }, message: "must have required property 'roots'" };
        vErrors === null ? vErrors = [err2] : vErrors.push(err2), errors++;
      }
      if (data.roots !== void 0) {
        ...
        if (Array.isArray(data1)) {
          if (data1.length < 1) {
            let err3 = { instancePath: instancePath + "/roots", schemaPath: "#/$defs/workSource/properties/roots/minItems", keyword: "minItems", params: { limit: 1 }, message: "must NOT have fewer than 1 items" };
            vErrors === null ? vErrors = [err3] : vErrors.push(err3), errors++;
          }
          ...
          for (let i0 = 0; i0 < len0; i0++) {
            ...
            if (typeof data2 == "string") {
              if (func2(data2) < 1) {
                let err4 = { instancePath: instancePath + "/roots/" + i0, schemaPath: "#/$defs/workSource/properties/roots/items/minLength", keyword: "minLength", params: { limit: 1 }, message: "must NOT have fewer than 1 characters" };
                vErrors === null ? vErrors = [err4] : vErrors.push(err4), errors++;
              }
            } else {
              let err5 = { instancePath: instancePath + "/roots/" + i0, schemaPath: "#/$defs/workSource/properties/roots/items/type", keyword: "type", params: { type: "string" }, message: "must be string" };
              vErrors === null ? vErrors = [err5] : vErrors.push(err5), errors++;
            }
          }
        } else {
          let err6 = { instancePath: instancePath + "/roots", schemaPath: "#/$defs/workSource/properties/roots/type", keyword: "type", params: { type: "array" }, message: "must be array" };
          vErrors === null ? vErrors = [err6] : vErrors.push(err6), errors++;
        }
      }
    }
  ...
  if (!valid1) {
    let err7 = { instancePath, schemaPath: "#/allOf/0/if", keyword: "if", params: { failingKeyword: "then" }, message: 'must match "then" schema' };
    vErrors === null ? vErrors = [err7] : vErrors.push(err7), errors++;
  }
  let _errs12 = errors, valid7 = !0, _errs13 = errors;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    let missing1;
    if (data.transport === void 0 && (missing1 = "transport")) {
      let err8 = {};
      vErrors === null ? vErrors = [err8] : vErrors.push(err8), errors++;
    } else if (data.transport !== void 0 && data.transport !== "mcp") {
      let err9 = {};
      vErrors === null ? vErrors = [err9] : vErrors.push(err9), errors++;
    }
  }
  var _valid1 = _errs13 === errors;
  if (errors = _errs12, vErrors !== null && (_errs12 ? vErrors.length = _errs12 : vErrors = null), _valid1) {
    let _errs15 = errors;
    if (data && typeof data == "object" && !Array.isArray(data)) {
      if (data.mcp_connection_ref === void 0) {
        let err10 = { instancePath, schemaPath: "#/allOf/1/then/required", keyword: "required", params: { missingProperty: "mcp_connection_ref" }, message: "must have required property 'mcp_connection_ref'" };
        vErrors === null ? vErrors = [err10] : vErrors.push(err10), errors++;
      }
      if (data.mcp_connection_ref !== void 0) {
        let data4 = data.mcp_connection_ref;
        if (typeof data4 == "string") {
          if (!pattern1.test(data4)) {
            let err11 = { instancePath: instancePath + "/mcp_connection_ref", schemaPath: "#/$defs/workSource/properties/mcp_connection_ref/pattern", keyword: "pattern", params: { pattern: "^[A-Za-z0-9][A-Za-z0-9._:-]{0,127}$" }, message: 'must match pattern "^[A-Za-z0-9][A-Za-z0-9._:-]{0,127}$"' };
            vErrors === null ? vErrors = [err11] : vErrors.push(err11), errors++;
          }
        } else {
          let err12 = { instancePath: instancePath + "/mcp_connection_ref", schemaPath: "#/$defs/workSource/properties/mcp_connection_ref/type", keyword: "type", params: { type: "string" }, message: "must be string" };
          vErrors === null ? vErrors = [err12] : vErrors.push(err12), errors++;
        }
      }
    }
  ...
  if (!valid7) {
    let err13 = { instancePath, schemaPath: "#/allOf/1/if", keyword: "if", params: { failingKeyword: "then" }, message: 'must match "then" schema' };
    vErrors === null ? vErrors = [err13] : vErrors.push(err13), errors++;
  }
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.id === void 0) {
      let err14 = { instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: "id" }, message: "must have required property 'id'" };
      vErrors === null ? vErrors = [err14] : vErrors.push(err14), errors++;
    }
    if (data.provider === void 0) {
      let err15 = { instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: "provider" }, message: "must have required property 'provider'" };
      vErrors === null ? vErrors = [err15] : vErrors.push(err15), errors++;
    }
    if (data.enabled === void 0) {
      let err16 = { instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: "enabled" }, message: "must have required property 'enabled'" };
      vErrors === null ? vErrors = [err16] : vErrors.push(err16), errors++;
    }
    if (data.source_policy === void 0) {
      let err17 = { instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: "source_policy" }, message: "must have required property 'source_policy'" };
      vErrors === null ? vErrors = [err17] : vErrors.push(err17), errors++;
    }
    if (data.sync_mode === void 0) {
      let err18 = { instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: "sync_mode" }, message: "must have required property 'sync_mode'" };
      vErrors === null ? vErrors = [err18] : vErrors.push(err18), errors++;
    }
    for (let key0 in data)
      if (!func5.call(schema20.properties, key0)) {
    ...
    if (data.id !== void 0) {
      ...
      if (typeof data5 == "string") {
        if (!pattern2.test(data5)) {
          let err20 = { instancePath: instancePath + "/id", schemaPath: "#/properties/id/pattern", keyword: "pattern", params: { pattern: "^[a-z][a-z0-9]*(?:-[a-z0-9]+)*$" }, message: 'must match pattern "^[a-z][a-z0-9]*(?:-[a-z0-9]+)*$"' };
          vErrors === null ? vErrors = [err20] : vErrors.push(err20), errors++;
        }
      } else {
        let err21 = { instancePath: instancePath + "/id", schemaPath: "#/properties/id/type", keyword: "type", params: { type: "string" }, message: "must be string" };
        vErrors === null ? vErrors = [err21] : vErrors.push(err21), errors++;
      }
    }
    if (data.provider !== void 0) {
      let data6 = data.provider;
      if (!(data6 === "local_repository" || data6 === "jira" || data6 === "github_issues" || data6 === "azure_boards" || data6 === "linear" || data6 === "custom")) {
        let err22 = { instancePath: instancePath + "/provider", schemaPath: "#/properties/provider/enum", keyword: "enum", params: { allowedValues: schema20.properties.provider.enum }, message: "must be equal to one of the allowed values" };
        vErrors === null ? vErrors = [err22] : vErrors.push(err22), errors++;
      }
    }
    if (data.enabled !== void 0 && typeof data.enabled != "boolean") {
      let err23 = { instancePath: instancePath + "/enabled", schemaPath: "#/properties/enabled/type", keyword: "type", params: { type: "boolean" }, message: "must be boolean" };
      vErrors === null ? vErrors = [err23] : vErrors.push(err23), errors++;
    }
    if (data.transport !== void 0) {
      let data8 = data.transport;
      if (!(data8 === "filesystem" || data8 === "http" || data8 === "mcp" || data8 === "provider_api" || data8 === "custom")) {
        let err24 = { instancePath: instancePath + "/transport", schemaPath: "#/properties/transport/enum", keyword: "enum", params: { allowedValues: schema20.properties.transport.enum }, message: "must be equal to one of the allowed values" };
        vErrors === null ? vErrors = [err24] : vErrors.push(err24), errors++;
      }
    }
    if (data.roots !== void 0) {
      let data9 = data.roots;
      if (Array.isArray(data9)) {
        if (data9.length < 1) {
          let err25 = { instancePath: instancePath + "/roots", schemaPath: "#/properties/roots/minItems", keyword: "minItems", params: { limit: 1 }, message: "must NOT have fewer than 1 items" };
          vErrors === null ? vErrors = [err25] : vErrors.push(err25), errors++;
        }
        let len1 = data9.length;
        for (let i1 = 0; i1 < len1; i1++) {
          let data10 = data9[i1];
          if (typeof data10 == "string") {
            if (func2(data10) < 1) {
              let err26 = { instancePath: instancePath + "/roots/" + i1, schemaPath: "#/properties/roots/items/minLength", keyword: "minLength", params: { limit: 1 }, message: "must NOT have fewer than 1 characters" };
              vErrors === null ? vErrors = [err26] : vErrors.push(err26), errors++;
            }
          } else {
            let err27 = { instancePath: instancePath + "/roots/" + i1, schemaPath: "#/properties/roots/items/type", keyword: "type", params: { type: "string" }, message: "must be string" };
            vErrors === null ? vErrors = [err27] : vErrors.push(err27), errors++;
          }
        }
      } else {
        let err28 = { instancePath: instancePath + "/roots", schemaPath: "#/properties/roots/type", keyword: "type", params: { type: "array" }, message: "must be array" };
        vErrors === null ? vErrors = [err28] : vErrors.push(err28), errors++;
      }
    }
    if (data.queries !== void 0) {
      let data11 = data.queries;
      if (Array.isArray(data11)) {
        if (data11.length < 1) {
          let err29 = { instancePath: instancePath + "/queries", schemaPath: "#/properties/queries/minItems", keyword: "minItems", params: { limit: 1 }, message: "must NOT have fewer than 1 items" };
          vErrors === null ? vErrors = [err29] : vErrors.push(err29), errors++;
        }
        let len2 = data11.length;
        for (let i2 = 0; i2 < len2; i2++) {
          let data12 = data11[i2];
          if (typeof data12 == "string") {
            if (func2(data12) < 1) {
              let err30 = { instancePath: instancePath + "/queries/" + i2, schemaPath: "#/properties/queries/items/minLength", keyword: "minLength", params: { limit: 1 }, message: "must NOT have fewer than 1 characters" };
              vErrors === null ? vErrors = [err30] : vErrors.push(err30), errors++;
            }
          } else {
            let err31 = { instancePath: instancePath + "/queries/" + i2, schemaPath: "#/properties/queries/items/type", keyword: "type", params: { type: "string" }, message: "must be string" };
            vErrors === null ? vErrors = [err31] : vErrors.push(err31), errors++;
          }
        }
      } else {
        let err32 = { instancePath: instancePath + "/queries", schemaPath: "#/properties/queries/type", keyword: "type", params: { type: "array" }, message: "must be array" };
        vErrors === null ? vErrors = [err32] : vErrors.push(err32), errors++;
      }
    }
    if (data.source_policy !== void 0) {
      let data13 = data.source_policy;
      if (!(data13 === "external_authoritative" || data13 === "shipping_mode_authoritative" || data13 === "import_snapshot" || data13 === "bidirectional_controlled")) {
        let err33 = { instancePath: instancePath + "/source_policy", schemaPath: "#/properties/source_policy/enum", keyword: "enum", params: { allowedValues: schema20.properties.source_policy.enum }, message: "must be equal to one of the allowed values" };
        vErrors === null ? vErrors = [err33] : vErrors.push(err33), errors++;
      }
    }
    if (data.sync_mode !== void 0) {
      let data14 = data.sync_mode;
      if (!(data14 === "import_only" || data14 === "pull" || data14 === "push" || data14 === "bidirectional")) {
        let err34 = { instancePath: instancePath + "/sync_mode", schemaPath: "#/properties/sync_mode/enum", keyword: "enum", params: { allowedValues: schema20.properties.sync_mode.enum }, message: "must be equal to one of the allowed values" };
        vErrors === null ? vErrors = [err34] : vErrors.push(err34), errors++;
      }
    }
    if (data.mcp_connection_ref !== void 0) {
      let data15 = data.mcp_connection_ref;
      if (typeof data15 == "string") {
        if (!pattern1.test(data15)) {
          let err35 = { instancePath: instancePath + "/mcp_connection_ref", schemaPath: "#/properties/mcp_connection_ref/pattern", keyword: "pattern", params: { pattern: "^[A-Za-z0-9][A-Za-z0-9._:-]{0,127}$" }, message: 'must match pattern "^[A-Za-z0-9][A-Za-z0-9._:-]{0,127}$"' };
          vErrors === null ? vErrors = [err35] : vErrors.push(err35), errors++;
        }
      } else {
        let err36 = { instancePath: instancePath + "/mcp_connection_ref", schemaPath: "#/properties/mcp_connection_ref/type", keyword: "type", params: { type: "string" }, message: "must be string" };
        vErrors === null ? vErrors = [err36] : vErrors.push(err36), errors++;
      }
    }
    if (data.capability_config_ref !== void 0) {
      let data16 = data.capability_config_ref;
      if (typeof data16 == "string") {
        if (!pattern1.test(data16)) {
          let err37 = { instancePath: instancePath + "/capability_config_ref", schemaPath: "#/properties/capability_config_ref/pattern", keyword: "pattern", params: { pattern: "^[A-Za-z0-9][A-Za-z0-9._:-]{0,127}$" }, message: 'must match pattern "^[A-Za-z0-9][A-Za-z0-9._:-]{0,127}$"' };
          vErrors === null ? vErrors = [err37] : vErrors.push(err37), errors++;
        }
      } else {
        let err38 = { instancePath: instancePath + "/capability_config_ref", schemaPath: "#/properties/capability_config_ref/type", keyword: "type", params: { type: "string" }, message: "must be string" };
        vErrors === null ? vErrors = [err38] : vErrors.push(err38), errors++;
      }
    }
  } else {
    ...
    if (data && typeof data == "object" && !Array.isArray(data) && data.payload !== void 0) {
      ...
      if (data9 && typeof data9 == "object" && !Array.isArray(data9)) {
        if (Object.keys(data9).length < 1) {
          let err18 = { instancePath: instancePath + "/payload", schemaPath: "#/allOf/1/then/properties/payload/minProperties", keyword: "minProperties", params: { limit: 1 }, message: "must NOT have fewer than 1 properties" };
          vErrors === null ? vErrors = [err18] : vErrors.push(err18), errors++;
        }
              ...
              outer0: for (; i1--; )
                for (j0 = i1; j0--; )
                  if (func0(data12[i1], data12[j0])) {
                    let err22 = { instancePath: instancePath + "/payload/work_sources", schemaPath: "#/allOf/1/then/properties/payload/properties/work_sources/uniqueItems", keyword: "uniqueItems", params: { i: i1, j: j0 }, message: "must NOT have duplicate items (items ## " + j0 + " and " + i1 + " are identical)" };
                    vErrors === null ? vErrors = [err22] : vErrors.push(err22), errors++;
                    break outer0;
                  }
            }
          } else {
            let err23 = { instancePath: instancePath + "/payload/work_sources", schemaPath: "#/allOf/1/then/properties/payload/properties/work_sources/type", keyword: "type", params: { type: "array" }, message: "must be array" };
            vErrors === null ? vErrors = [err23] : vErrors.push(err23), errors++;
          }
        }
      } else {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.baseBranch !== void 0) {
      ...
      if (typeof data2 != "string" && data2 !== null) {
        let err13 = { instancePath: instancePath + "/baseBranch", schemaPath: "#/properties/baseBranch/type", keyword: "type", params: { type: schema12.properties.baseBranch.type }, message: "must be string,null" };
        vErrors === null ? vErrors = [err13] : vErrors.push(err13), errors++;
      }
    }
    if (data.vcs !== void 0) {
      ...
      if (!(data3 === "git" || data3 === "none")) {
        let err14 = { instancePath: instancePath + "/vcs", schemaPath: "#/properties/vcs/enum", keyword: "enum", params: { allowedValues: schema12.properties.vcs.enum }, message: "must be equal to one of the allowed values" };
        vErrors === null ? vErrors = [err14] : vErrors.push(err14), errors++;
      }
    }
    if (data.git !== void 0 && (validate12(data.git, { instancePath: instancePath + "/git", parentData: data, parentDataProperty: "git", rootData }) || (vErrors = vErrors === null ? validate12.errors : vErrors.concat(validate12.errors), errors = vErrors.length)), data.work_sources !== void 0) {
      let data5 = data.work_sources;
      if (Array.isArray(data5)) {
        let len0 = data5.length;
        for (let i0 = 0; i0 < len0; i0++)
          validate14(data5[i0], { instancePath: instancePath + "/work_sources/" + i0, parentData: data5, parentDataProperty: i0, rootData }) || (vErrors = vErrors === null ? validate14.errors : vErrors.concat(validate14.errors), errors = vErrors.length);
        let i1 = data5.length, j0;
        if (i1 > 1) {
          outer0: for (; i1--; )
            for (j0 = i1; j0--; )
              if (func0(data5[i1], data5[j0])) {
                let err15 = { instancePath: instancePath + "/work_sources", schemaPath: "#/properties/work_sources/uniqueItems", keyword: "uniqueItems", params: { i: i1, j: j0 }, message: "must NOT have duplicate items (items ## " + j0 + " and " + i1 + " are identical)" };
                vErrors === null ? vErrors = [err15] : vErrors.push(err15), errors++;
                break outer0;
              }
        }
      } else {
        let err16 = { instancePath: instancePath + "/work_sources", schemaPath: "#/properties/work_sources/type", keyword: "type", params: { type: "array" }, message: "must be array" };
        vErrors === null ? vErrors = [err16] : vErrors.push(err16), errors++;
      }
    }
    if (data.project !== void 0) {
      ...
      if (data7 && typeof data7 == "object" && !Array.isArray(data7)) {
        if (data7.name === void 0) {
          let err17 = { instancePath: instancePath + "/project", schemaPath: "#/properties/project/required", keyword: "required", params: { missingProperty: "name" }, message: "must have required property 'name'" };
          vErrors === null ? vErrors = [err17] : vErrors.push(err17), errors++;
        }
        if (data7.type === void 0) {
          let err18 = { instancePath: instancePath + "/project", schemaPath: "#/properties/project/required", keyword: "required", params: { missingProperty: "type" }, message: "must have required property 'type'" };
          vErrors === null ? vErrors = [err18] : vErrors.push(err18), errors++;
        }
        for (let key1 in data7)
          if (!(key1 === "name" || key1 === "type")) {
            let err19 = { instancePath: instancePath + "/project", schemaPath: "#/properties/project/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key1 }, message: "must NOT have additional properties" };
            vErrors === null ? vErrors = [err19] : vErrors.push(err19), errors++;
          }
        if (data7.name !== void 0) {
          ...
          if (typeof data8 == "string") {
            if (func2(data8) < 1) {
              let err20 = { instancePath: instancePath + "/project/name", schemaPath: "#/properties/project/properties/name/minLength", keyword: "minLength", params: { limit: 1 }, message: "must NOT have fewer than 1 characters" };
              vErrors === null ? vErrors = [err20] : vErrors.push(err20), errors++;
            }
          } else {
            let err21 = { instancePath: instancePath + "/project/name", schemaPath: "#/properties/project/properties/name/type", keyword: "type", params: { type: "string" }, message: "must be string" };
            vErrors === null ? vErrors = [err21] : vErrors.push(err21), errors++;
          }
        }
        if (data7.type !== void 0) {
          ...
          if (!(data9 === "software" || data9 === "non_software" || data9 === "mixed" || data9 === "unknown")) {
            let err22 = { instancePath: instancePath + "/project/type", schemaPath: "#/properties/project/properties/type/enum", keyword: "enum", params: { allowedValues: schema12.properties.project.properties.type.enum }, message: "must be equal to one of the allowed values" };
            vErrors === null ? vErrors = [err22] : vErrors.push(err22), errors++;
          }
        }
      } else {
        let err23 = { instancePath: instancePath + "/project", schemaPath: "#/properties/project/type", keyword: "type", params: { type: "object" }, message: "must be object" };
        vErrors === null ? vErrors = [err23] : vErrors.push(err23), errors++;
      }
    }
    if (data.plugin !== void 0) {
      ...
      if (data10 && typeof data10 == "object" && !Array.isArray(data10)) {
        if (data10.schemaVersion === void 0) {
          let err24 = { instancePath: instancePath + "/plugin", schemaPath: "#/properties/plugin/required", keyword: "required", params: { missingProperty: "schemaVersion" }, message: "must have required property 'schemaVersion'" };
          vErrors === null ? vErrors = [err24] : vErrors.push(err24), errors++;
        }
        if (data10.launcher === void 0) {
          let err25 = { instancePath: instancePath + "/plugin", schemaPath: "#/properties/plugin/required", keyword: "required", params: { missingProperty: "launcher" }, message: "must have required property 'launcher'" };
          vErrors === null ? vErrors = [err25] : vErrors.push(err25), errors++;
        }
        for (let key2 in data10)
          if (!(key2 === "schemaVersion" || key2 === "launcher")) {
            let err26 = { instancePath: instancePath + "/plugin", schemaPath: "#/properties/plugin/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key2 }, message: "must NOT have additional properties" };
            vErrors === null ? vErrors = [err26] : vErrors.push(err26), errors++;
          }
        if (data10.schemaVersion !== void 0 && data10.schemaVersion !== 1) {
          let err27 = { instancePath: instancePath + "/plugin/schemaVersion", schemaPath: "#/properties/plugin/properties/schemaVersion/const", keyword: "const", params: { allowedValue: 1 }, message: "must be equal to constant" };
          vErrors === null ? vErrors = [err27] : vErrors.push(err27), errors++;
        }
        if (data10.launcher !== void 0 && data10.launcher !== "shipping-mode") {
          let err28 = { instancePath: instancePath + "/plugin/launcher", schemaPath: "#/properties/plugin/properties/launcher/const", keyword: "const", params: { allowedValue: "shipping-mode" }, message: "must be equal to constant" };
          vErrors === null ? vErrors = [err28] : vErrors.push(err28), errors++;
        }
      } else {
        let err29 = { instancePath: instancePath + "/plugin", schemaPath: "#/properties/plugin/type", keyword: "type", params: { type: "object" }, message: "must be object" };
        vErrors === null ? vErrors = [err29] : vErrors.push(err29), errors++;
      }
    }
    if (data.policies !== void 0) {
      ...
      if (data13 && typeof data13 == "object" && !Array.isArray(data13)) {
        if (data13.release === void 0) {
          let err30 = { instancePath: instancePath + "/policies", schemaPath: "#/properties/policies/required", keyword: "required", params: { missingProperty: "release" }, message: "must have required property 'release'" };
          vErrors === null ? vErrors = [err30] : vErrors.push(err30), errors++;
        }
        if (data13.workSources === void 0) {
          let err31 = { instancePath: instancePath + "/policies", schemaPath: "#/properties/policies/required", keyword: "required", params: { missingProperty: "workSources" }, message: "must have required property 'workSources'" };
          vErrors === null ? vErrors = [err31] : vErrors.push(err31), errors++;
        }
        if (data13.paths === void 0) {
          let err32 = { instancePath: instancePath + "/policies", schemaPath: "#/properties/policies/required", keyword: "required", params: { missingProperty: "paths" }, message: "must have required property 'paths'" };
          vErrors === null ? vErrors = [err32] : vErrors.push(err32), errors++;
        }
        for (let key3 in data13)
          if (!(key3 === "release" || key3 === "workSources" || key3 === "paths")) {
            let err33 = { instancePath: instancePath + "/policies", schemaPath: "#/properties/policies/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key3 }, message: "must NOT have additional properties" };
            vErrors === null ? vErrors = [err33] : vErrors.push(err33), errors++;
          }
        if (data13.release !== void 0) {
          ...
          if (data14 && typeof data14 == "object" && !Array.isArray(data14)) {
            if (data14.mode === void 0) {
              let err34 = { instancePath: instancePath + "/policies/release", schemaPath: "#/properties/policies/properties/release/required", keyword: "required", params: { missingProperty: "mode" }, message: "must have required property 'mode'" };
              vErrors === null ? vErrors = [err34] : vErrors.push(err34), errors++;
            }
            if (data14.defaultLane === void 0) {
              let err35 = { instancePath: instancePath + "/policies/release", schemaPath: "#/properties/policies/properties/release/required", keyword: "required", params: { missingProperty: "defaultLane" }, message: "must have required property 'defaultLane'" };
              vErrors === null ? vErrors = [err35] : vErrors.push(err35), errors++;
            }
            for (let key4 in data14)
              if (!(key4 === "mode" || key4 === "defaultLane")) {
                let err36 = { instancePath: instancePath + "/policies/release", schemaPath: "#/properties/policies/properties/release/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key4 }, message: "must NOT have additional properties" };
                vErrors === null ? vErrors = [err36] : vErrors.push(err36), errors++;
              }
            if (data14.mode !== void 0 && data14.mode !== "strict_sequence") {
              let err37 = { instancePath: instancePath + "/policies/release/mode", schemaPath: "#/properties/policies/properties/release/properties/mode/enum", keyword: "enum", params: { allowedValues: schema12.properties.policies.properties.release.properties.mode.enum }, message: "must be equal to one of the allowed values" };
              vErrors === null ? vErrors = [err37] : vErrors.push(err37), errors++;
            }
            if (data14.defaultLane !== void 0) {
              ...
              if (typeof data16 == "string") {
                if (func2(data16) < 1) {
                  let err38 = { instancePath: instancePath + "/policies/release/defaultLane", schemaPath: "#/properties/policies/properties/release/properties/defaultLane/minLength", keyword: "minLength", params: { limit: 1 }, message: "must NOT have fewer than 1 characters" };
                  vErrors === null ? vErrors = [err38] : vErrors.push(err38), errors++;
                }
              } else {
                let err39 = { instancePath: instancePath + "/policies/release/defaultLane", schemaPath: "#/properties/policies/properties/release/properties/defaultLane/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                vErrors === null ? vErrors = [err39] : vErrors.push(err39), errors++;
              }
            }
          } else {
            let err40 = { instancePath: instancePath + "/policies/release", schemaPath: "#/properties/policies/properties/release/type", keyword: "type", params: { type: "object" }, message: "must be object" };
            vErrors === null ? vErrors = [err40] : vErrors.push(err40), errors++;
          }
        }
        if (data13.workSources !== void 0) {
          ...
          if (data17 && typeof data17 == "object" && !Array.isArray(data17)) {
            if (data17.defaultSyncMode === void 0) {
              let err41 = { instancePath: instancePath + "/policies/workSources", schemaPath: "#/properties/policies/properties/workSources/required", keyword: "required", params: { missingProperty: "defaultSyncMode" }, message: "must have required property 'defaultSyncMode'" };
              vErrors === null ? vErrors = [err41] : vErrors.push(err41), errors++;
            }
            if (data17.defaultSourcePolicy === void 0) {
              let err42 = { instancePath: instancePath + "/policies/workSources", schemaPath: "#/properties/policies/properties/workSources/required", keyword: "required", params: { missingProperty: "defaultSourcePolicy" }, message: "must have required property 'defaultSourcePolicy'" };
              vErrors === null ? vErrors = [err42] : vErrors.push(err42), errors++;
            }
            if (data17.externalWrites === void 0) {
              let err43 = { instancePath: instancePath + "/policies/workSources", schemaPath: "#/properties/policies/properties/workSources/required", keyword: "required", params: { missingProperty: "externalWrites" }, message: "must have required property 'externalWrites'" };
              vErrors === null ? vErrors = [err43] : vErrors.push(err43), errors++;
            }
            for (let key5 in data17)
              if (!(key5 === "defaultSyncMode" || key5 === "defaultSourcePolicy" || key5 === "externalWrites")) {
                let err44 = { instancePath: instancePath + "/policies/workSources", schemaPath: "#/properties/policies/properties/workSources/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key5 }, message: "must NOT have additional properties" };
                vErrors === null ? vErrors = [err44] : vErrors.push(err44), errors++;
              }
            if (data17.defaultSyncMode !== void 0 && data17.defaultSyncMode !== "import_only") {
              let err45 = { instancePath: instancePath + "/policies/workSources/defaultSyncMode", schemaPath: "#/properties/policies/properties/workSources/properties/defaultSyncMode/enum", keyword: "enum", params: { allowedValues: schema12.properties.policies.properties.workSources.properties.defaultSyncMode.enum }, message: "must be equal to one of the allowed values" };
              vErrors === null ? vErrors = [err45] : vErrors.push(err45), errors++;
            }
            if (data17.defaultSourcePolicy !== void 0 && data17.defaultSourcePolicy !== "import_snapshot") {
              let err46 = { instancePath: instancePath + "/policies/workSources/defaultSourcePolicy", schemaPath: "#/properties/policies/properties/workSources/properties/defaultSourcePolicy/enum", keyword: "enum", params: { allowedValues: schema12.properties.policies.properties.workSources.properties.defaultSourcePolicy.enum }, message: "must be equal to one of the allowed values" };
              vErrors === null ? vErrors = [err46] : vErrors.push(err46), errors++;
            }
            if (data17.externalWrites !== void 0 && data17.externalWrites !== "approval_required") {
              let err47 = { instancePath: instancePath + "/policies/workSources/externalWrites", schemaPath: "#/properties/policies/properties/workSources/properties/externalWrites/enum", keyword: "enum", params: { allowedValues: schema12.properties.policies.properties.workSources.properties.externalWrites.enum }, message: "must be equal to one of the allowed values" };
              vErrors === null ? vErrors = [err47] : vErrors.push(err47), errors++;
            }
          } else {
            let err48 = { instancePath: instancePath + "/policies/workSources", schemaPath: "#/properties/policies/properties/workSources/type", keyword: "type", params: { type: "object" }, message: "must be object" };
            vErrors === null ? vErrors = [err48] : vErrors.push(err48), errors++;
          }
        }
        if (data13.paths !== void 0) {
          ...
          if (data21 && typeof data21 == "object" && !Array.isArray(data21)) {
            if (data21.workspaceBoundary === void 0) {
              let err49 = { instancePath: instancePath + "/policies/paths", schemaPath: "#/properties/policies/properties/paths/required", keyword: "required", params: { missingProperty: "workspaceBoundary" }, message: "must have required property 'workspaceBoundary'" };
              vErrors === null ? vErrors = [err49] : vErrors.push(err49), errors++;
            }
            for (let key6 in data21)
              if (key6 !== "workspaceBoundary") {
                let err50 = { instancePath: instancePath + "/policies/paths", schemaPath: "#/properties/policies/properties/paths/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key6 }, message: "must NOT have additional properties" };
                vErrors === null ? vErrors = [err50] : vErrors.push(err50), errors++;
              }
            if (data21.workspaceBoundary !== void 0 && data21.workspaceBoundary !== "current_directory") {
              let err51 = { instancePath: instancePath + "/policies/paths/workspaceBoundary", schemaPath: "#/properties/policies/properties/paths/properties/workspaceBoundary/enum", keyword: "enum", params: { allowedValues: schema12.properties.policies.properties.paths.properties.workspaceBoundary.enum }, message: "must be equal to one of the allowed values" };
              vErrors === null ? vErrors = [err51] : vErrors.push(err51), errors++;
            }
          } else {
            let err52 = { instancePath: instancePath + "/policies/paths", schemaPath: "#/properties/policies/properties/paths/type", keyword: "type", params: { type: "object" }, message: "must be object" };
            vErrors === null ? vErrors = [err52] : vErrors.push(err52), errors++;
          }
        }
      } else {
        let err53 = { instancePath: instancePath + "/policies", schemaPath: "#/properties/policies/type", keyword: "type", params: { type: "object" }, message: "must be object" };
        vErrors === null ? vErrors = [err53] : vErrors.push(err53), errors++;
      }
    }
    if (data.scopeCatalog !== void 0) {
      ...
      if (data23 && typeof data23 == "object" && !Array.isArray(data23)) {
        if (data23.directory === void 0) {
          let err54 = { instancePath: instancePath + "/scopeCatalog", schemaPath: "#/properties/scopeCatalog/required", keyword: "required", params: { missingProperty: "directory" }, message: "must have required property 'directory'" };
          vErrors === null ? vErrors = [err54] : vErrors.push(err54), errors++;
        }
        if (data23.enabled === void 0) {
          let err55 = { instancePath: instancePath + "/scopeCatalog", schemaPath: "#/properties/scopeCatalog/required", keyword: "required", params: { missingProperty: "enabled" }, message: "must have required property 'enabled'" };
          vErrors === null ? vErrors = [err55] : vErrors.push(err55), errors++;
        }
        for (let key7 in data23)
          if (!(key7 === "directory" || key7 === "enabled")) {
            let err56 = { instancePath: instancePath + "/scopeCatalog", schemaPath: "#/properties/scopeCatalog/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key7 }, message: "must NOT have additional properties" };
            vErrors === null ? vErrors = [err56] : vErrors.push(err56), errors++;
          }
        if (data23.directory !== void 0 && data23.directory !== ".planning/scopes") {
          let err57 = { instancePath: instancePath + "/scopeCatalog/directory", schemaPath: "#/properties/scopeCatalog/properties/directory/const", keyword: "const", params: { allowedValue: ".planning/scopes" }, message: "must be equal to constant" };
          vErrors === null ? vErrors = [err57] : vErrors.push(err57), errors++;
        }
        if (data23.enabled !== void 0) {
          ...
          if (Array.isArray(data25)) {
            ...
            for (let i2 = 0; i2 < len1; i2++) {
              ...
              if (typeof data26 == "string") {
                if (!pattern5.test(data26)) {
                  let err58 = { instancePath: instancePath + "/scopeCatalog/enabled/" + i2, schemaPath: "#/properties/scopeCatalog/properties/enabled/items/pattern", keyword: "pattern", params: { pattern: "^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$" }, message: 'must match pattern "^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$"' };
                  vErrors === null ? vErrors = [err58] : vErrors.push(err58), errors++;
                }
              } else {
                let err59 = { instancePath: instancePath + "/scopeCatalog/enabled/" + i2, schemaPath: "#/properties/scopeCatalog/properties/enabled/items/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                vErrors === null ? vErrors = [err59] : vErrors.push(err59), errors++;
              }
            }
              ...
              for (; i3--; ) {
                ...
                if (typeof item0 == "string") {
                  if (typeof indices0[item0] == "number") {
                    j1 = indices0[item0];
                    let err60 = { instancePath: instancePath + "/scopeCatalog/enabled", schemaPath: "#/properties/scopeCatalog/properties/enabled/uniqueItems", keyword: "uniqueItems", params: { i: i3, j: j1 }, message: "must NOT have duplicate items (items ## " + j1 + " and " + i3 + " are identical)" };
                    vErrors === null ? vErrors = [err60] : vErrors.push(err60), errors++;
                    break;
                  }
                  indices0[item0] = i3;
            ...
            let err61 = { instancePath: instancePath + "/scopeCatalog/enabled", schemaPath: "#/properties/scopeCatalog/properties/enabled/type", keyword: "type", params: { type: "array" }, message: "must be array" };
            vErrors === null ? vErrors = [err61] : vErrors.push(err61), errors++;
          }
        }
      } else {
        let err62 = { instancePath: instancePath + "/scopeCatalog", schemaPath: "#/properties/scopeCatalog/type", keyword: "type", params: { type: "object" }, message: "must be object" };
        vErrors === null ? vErrors = [err62] : vErrors.push(err62), errors++;
      }
    }
    if (data.runtime !== void 0) {
      ...
      if (data27 && typeof data27 == "object" && !Array.isArray(data27)) {
        if (data27.eventStore === void 0) {
          let err63 = { instancePath: instancePath + "/runtime", schemaPath: "#/properties/runtime/required", keyword: "required", params: { missingProperty: "eventStore" }, message: "must have required property 'eventStore'" };
          vErrors === null ? vErrors = [err63] : vErrors.push(err63), errors++;
        }
        if (data27.operationStore === void 0) {
          let err64 = { instancePath: instancePath + "/runtime", schemaPath: "#/properties/runtime/required", keyword: "required", params: { missingProperty: "operationStore" }, message: "must have required property 'operationStore'" };
          vErrors === null ? vErrors = [err64] : vErrors.push(err64), errors++;
        }
        if (data27.runtimeStore === void 0) {
          let err65 = { instancePath: instancePath + "/runtime", schemaPath: "#/properties/runtime/required", keyword: "required", params: { missingProperty: "runtimeStore" }, message: "must have required property 'runtimeStore'" };
          vErrors === null ? vErrors = [err65] : vErrors.push(err65), errors++;
        }
        if (data27.templateVendor === void 0) {
          let err66 = { instancePath: instancePath + "/runtime", schemaPath: "#/properties/runtime/required", keyword: "required", params: { missingProperty: "templateVendor" }, message: "must have required property 'templateVendor'" };
          vErrors === null ? vErrors = [err66] : vErrors.push(err66), errors++;
        }
        if (data27.operationRetentionDays === void 0) {
          let err67 = { instancePath: instancePath + "/runtime", schemaPath: "#/properties/runtime/required", keyword: "required", params: { missingProperty: "operationRetentionDays" }, message: "must have required property 'operationRetentionDays'" };
          vErrors === null ? vErrors = [err67] : vErrors.push(err67), errors++;
        }
        if (data27.retainFailedOperations === void 0) {
          let err68 = { instancePath: instancePath + "/runtime", schemaPath: "#/properties/runtime/required", keyword: "required", params: { missingProperty: "retainFailedOperations" }, message: "must have required property 'retainFailedOperations'" };
          vErrors === null ? vErrors = [err68] : vErrors.push(err68), errors++;
        }
        if (data27.retainBeforeSnapshots === void 0) {
          let err69 = { instancePath: instancePath + "/runtime", schemaPath: "#/properties/runtime/required", keyword: "required", params: { missingProperty: "retainBeforeSnapshots" }, message: "must have required property 'retainBeforeSnapshots'" };
          vErrors === null ? vErrors = [err69] : vErrors.push(err69), errors++;
        }
        if (data27.eventRetention === void 0) {
          let err70 = { instancePath: instancePath + "/runtime", schemaPath: "#/properties/runtime/required", keyword: "required", params: { missingProperty: "eventRetention" }, message: "must have required property 'eventRetention'" };
          vErrors === null ? vErrors = [err70] : vErrors.push(err70), errors++;
        }
        for (let key8 in data27)
          if (!(key8 === "eventStore" || key8 === "operationStore" || key8 === "runtimeStore" || key8 === "templateVendor" || key8 === "operationRetentionDays" || key8 === "retainFailedOperations" || key8 === "retainBeforeSnapshots" || key8 === "eventRetention")) {
            let err71 = { instancePath: instancePath + "/runtime", schemaPath: "#/properties/runtime/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key8 }, message: "must NOT have additional properties" };
            vErrors === null ? vErrors = [err71] : vErrors.push(err71), errors++;
          }
        if (data27.eventStore !== void 0 && data27.eventStore !== ".planning/events") {
          let err72 = { instancePath: instancePath + "/runtime/eventStore", schemaPath: "#/properties/runtime/properties/eventStore/const", keyword: "const", params: { allowedValue: ".planning/events" }, message: "must be equal to constant" };
          vErrors === null ? vErrors = [err72] : vErrors.push(err72), errors++;
        }
        if (data27.operationStore !== void 0 && data27.operationStore !== ".planning/operations") {
          let err73 = { instancePath: instancePath + "/runtime/operationStore", schemaPath: "#/properties/runtime/properties/operationStore/const", keyword: "const", params: { allowedValue: ".planning/operations" }, message: "must be equal to constant" };
          vErrors === null ? vErrors = [err73] : vErrors.push(err73), errors++;
        }
        if (data27.runtimeStore !== void 0 && data27.runtimeStore !== ".planning/.runtime") {
          let err74 = { instancePath: instancePath + "/runtime/runtimeStore", schemaPath: "#/properties/runtime/properties/runtimeStore/const", keyword: "const", params: { allowedValue: ".planning/.runtime" }, message: "must be equal to constant" };
          vErrors === null ? vErrors = [err74] : vErrors.push(err74), errors++;
        }
        if (data27.templateVendor !== void 0 && data27.templateVendor !== ".planning/vendor/template-packs") {
          let err75 = { instancePath: instancePath + "/runtime/templateVendor", schemaPath: "#/properties/runtime/properties/templateVendor/const", keyword: "const", params: { allowedValue: ".planning/vendor/template-packs" }, message: "must be equal to constant" };
          vErrors === null ? vErrors = [err75] : vErrors.push(err75), errors++;
        }
        if (data27.operationRetentionDays !== void 0) {
          let data32 = data27.operationRetentionDays;
          if (!(typeof data32 == "number" && !(data32 % 1) && !isNaN(data32) && isFinite(data32))) {
            let err76 = { instancePath: instancePath + "/runtime/operationRetentionDays", schemaPath: "#/properties/runtime/properties/operationRetentionDays/type", keyword: "type", params: { type: "integer" }, message: "must be integer" };
            vErrors === null ? vErrors = [err76] : vErrors.push(err76), errors++;
          }
          if (typeof data32 == "number" && isFinite(data32) && (data32 < 1 || isNaN(data32))) {
            let err77 = { instancePath: instancePath + "/runtime/operationRetentionDays", schemaPath: "#/properties/runtime/properties/operationRetentionDays/minimum", keyword: "minimum", params: { comparison: ">=", limit: 1 }, message: "must be >= 1" };
            vErrors === null ? vErrors = [err77] : vErrors.push(err77), errors++;
          }
        }
        if (data27.retainFailedOperations !== void 0 && typeof data27.retainFailedOperations != "boolean") {
          let err78 = { instancePath: instancePath + "/runtime/retainFailedOperations", schemaPath: "#/properties/runtime/properties/retainFailedOperations/type", keyword: "type", params: { type: "boolean" }, message: "must be boolean" };
          vErrors === null ? vErrors = [err78] : vErrors.push(err78), errors++;
        }
        if (data27.retainBeforeSnapshots !== void 0 && typeof data27.retainBeforeSnapshots != "boolean") {
          let err79 = { instancePath: instancePath + "/runtime/retainBeforeSnapshots", schemaPath: "#/properties/runtime/properties/retainBeforeSnapshots/type", keyword: "type", params: { type: "boolean" }, message: "must be boolean" };
          vErrors === null ? vErrors = [err79] : vErrors.push(err79), errors++;
        }
        if (data27.eventRetention !== void 0 && data27.eventRetention !== "permanent") {
          let err80 = { instancePath: instancePath + "/runtime/eventRetention", schemaPath: "#/properties/runtime/properties/eventRetention/const", keyword: "const", params: { allowedValue: "permanent" }, message: "must be equal to constant" };
          vErrors === null ? vErrors = [err80] : vErrors.push(err80), errors++;
        }
      } else {
        let err81 = { instancePath: instancePath + "/runtime", schemaPath: "#/properties/runtime/type", keyword: "type", params: { type: "object" }, message: "must be object" };
        vErrors === null ? vErrors = [err81] : vErrors.push(err81), errors++;
      }
    }
    if (data.scopeRefs !== void 0) {
      ...
      if (Array.isArray(data36)) {
        ...
        for (let i4 = 0; i4 < len2; i4++) {
          ...
          if (data37 && typeof data37 == "object" && !Array.isArray(data37)) {
            if (data37.id === void 0) {
              let err82 = { instancePath: instancePath + "/scopeRefs/" + i4, schemaPath: "#/properties/scopeRefs/items/required", keyword: "required", params: { missingProperty: "id" }, message: "must have required property 'id'" };
              vErrors === null ? vErrors = [err82] : vErrors.push(err82), errors++;
            }
            if (data37.key === void 0) {
              let err83 = { instancePath: instancePath + "/scopeRefs/" + i4, schemaPath: "#/properties/scopeRefs/items/required", keyword: "required", params: { missingProperty: "key" }, message: "must have required property 'key'" };
              vErrors === null ? vErrors = [err83] : vErrors.push(err83), errors++;
            }
            for (let key9 in data37)
              if (!(key9 === "id" || key9 === "key")) {
                let err84 = { instancePath: instancePath + "/scopeRefs/" + i4, schemaPath: "#/properties/scopeRefs/items/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key9 }, message: "must NOT have additional properties" };
                vErrors === null ? vErrors = [err84] : vErrors.push(err84), errors++;
              }
            if (data37.id !== void 0) {
              ...
              if (typeof data38 == "string") {
                if (!pattern5.test(data38)) {
                  let err85 = { instancePath: instancePath + "/scopeRefs/" + i4 + "/id", schemaPath: "#/properties/scopeRefs/items/properties/id/pattern", keyword: "pattern", params: { pattern: "^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$" }, message: 'must match pattern "^[0-9a-f]{8}-[0-9a-f]{4}-7[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$"' };
                  vErrors === null ? vErrors = [err85] : vErrors.push(err85), errors++;
                }
              } else {
                let err86 = { instancePath: instancePath + "/scopeRefs/" + i4 + "/id", schemaPath: "#/properties/scopeRefs/items/properties/id/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                vErrors === null ? vErrors = [err86] : vErrors.push(err86), errors++;
              }
            }
            if (data37.key !== void 0) {
              ...
              if (typeof data39 == "string") {
                if (!pattern7.test(data39)) {
                  let err87 = { instancePath: instancePath + "/scopeRefs/" + i4 + "/key", schemaPath: "#/properties/scopeRefs/items/properties/key/pattern", keyword: "pattern", params: { pattern: "^[a-z0-9]+(-[a-z0-9]+)*$" }, message: 'must match pattern "^[a-z0-9]+(-[a-z0-9]+)*$"' };
                  vErrors === null ? vErrors = [err87] : vErrors.push(err87), errors++;
                }
              } else {
                let err88 = { instancePath: instancePath + "/scopeRefs/" + i4 + "/key", schemaPath: "#/properties/scopeRefs/items/properties/key/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                vErrors === null ? vErrors = [err88] : vErrors.push(err88), errors++;
              }
            }
          } else {
            let err89 = { instancePath: instancePath + "/scopeRefs/" + i4, schemaPath: "#/properties/scopeRefs/items/type", keyword: "type", params: { type: "object" }, message: "must be object" };
            vErrors === null ? vErrors = [err89] : vErrors.push(err89), errors++;
          }
        }
      } else {
        let err90 = { instancePath: instancePath + "/scopeRefs", schemaPath: "#/properties/scopeRefs/type", keyword: "type", params: { type: "array" }, message: "must be array" };
        vErrors === null ? vErrors = [err90] : vErrors.push(err90), errors++;
      }
    }
    if (data.autonomy !== void 0) {
      ...
      if (data40 && typeof data40 == "object" && !Array.isArray(data40)) {
        if (data40.discovery === void 0) {
          let err91 = { instancePath: instancePath + "/autonomy", schemaPath: "#/properties/autonomy/required", keyword: "required", params: { missingProperty: "discovery" }, message: "must have required property 'discovery'" };
          vErrors === null ? vErrors = [err91] : vErrors.push(err91), errors++;
        }
        for (let key10 in data40)
          if (key10 !== "discovery") {
            let err92 = { instancePath: instancePath + "/autonomy", schemaPath: "#/properties/autonomy/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key10 }, message: "must NOT have additional properties" };
            vErrors === null ? vErrors = [err92] : vErrors.push(err92), errors++;
          }
        ...
        let err93 = { instancePath: instancePath + "/autonomy", schemaPath: "#/properties/autonomy/type", keyword: "type", params: { type: "object" }, message: "must be object" };
        vErrors === null ? vErrors = [err93] : vErrors.push(err93), errors++;
      }
    }
  } else {
...
function renderConfigUpdate(payload, currentConfig) {
  ...
  return payload.name !== void 0 && (nextConfig.name = payload.name, nextConfig.project = { ...baseConfig.project || {}, name: payload.name }), payload.git !== void 0 && (nextConfig.git = payload.git), payload.work_sources !== void 0 && (nextConfig.work_sources = payload.work_sources), /* @__PURE__ */ new Map([["config.yml", stringifyYaml(nextConfig)]]);
}
...
function checkProjectContextConsistency(config, findings) {
  ...
  checkGitPolicyConsistency(config, findings), checkWorkSourcesConsistency(config, findings);
}
function checkGitPolicyConsistency(config, findings) {
  ...
  let workBase = git.branches?.work_base;
  (config.baseBranch ?? null) !== (workBase ?? null) && findings.push("config.yml: git.branches.work_base must match compatibility field baseBranch");
  let integration = git.branches?.integration, production = git.branches?.production, promotion = git.pull_requests?.promotion;
  git.pull_requests?.work_target && integration && git.pull_requests.work_target !== integration && findings.push("config.yml: git.pull_requests.work_target must match git.branches.integration"), promotion?.source && integration && promotion.source !== integration && findings.push("config.yml: Git promotion source must match integration branch"), promotion?.target && production && promotion.target !== production && findings.push("config.yml: Git promotion target must match production branch"), workBase && integration && workBase === production && production !== null && findings.push("config.yml: work_base and production cannot be the same branch when integration is configured");
}
function checkWorkSourcesConsistency(config, findings) {
  let sources = config.work_sources || [], ids = /* @__PURE__ */ new Set();
  for (let source of sources) {
    ids.has(source.id) && findings.push(`config.yml: duplicate work source id ${source.id}`), ids.add(source.id), source.provider === "local_repository" && source.transport && source.transport !== "filesystem" && findings.push(`config.yml: local_repository work source ${source.id} must use filesystem transport`), source.provider !== "local_repository" && source.transport === "filesystem" && findings.push(`config.yml: non-local work source ${source.id} cannot use filesystem transport`);
    for (let root of source.roots || [])
      (path12.isAbsolute(root) || root.split(/[\\/]+/).includes("..")) && findings.push(`config.yml: work source ${source.id} root must remain inside the workspace`);
    source.transport === "mcp" && !source.mcp_connection_ref && findings.push(`config.yml: MCP work source ${source.id} requires an opaque mcp_connection_ref`), source.mcp_connection_ref && !/^[A-Za-z0-9][A-Za-z0-9._:-]{0,127}$/.test(source.mcp_connection_ref) && findings.push(`config.yml: work source ${source.id} has an invalid opaque connection reference`);
  }
}
