...
|---|---|---|---|---|
| 1 | Guide domain, schemas, storage and lifecycle | Guide metadata/content envelopes, scope references, ChangeSet mutations, legal transitions, approval binding, gap resolution | **Implementation complete; pending PR merge** | `2026-07-27-corte-1-plan-1-guide-domain-lifecycle.md` |
| 2 | Generation, DSL, projections and custom generators | Source-driven generation, closed executable DSL, deterministic Markdown projections, generator safety, gate/profile references | Pending Plan 1 | `2026-07-27-corte-1-plan-2-generation-projections-generators.md` |
...
execution implements only Plan 1.
